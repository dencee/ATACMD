...

{
   ...
   if ( pio_bmide_base_addr < 0x0100 )
      return 0;
   x = _INP(pio_bmide_base_addr + BM_COMMAND_REG );
...

{
   ...
   if ( pio_bmide_base_addr < 0x0100 )
      return 0;
   x = _INP( pio_bmide_base_addr + BM_STATUS_REG );
...

{
   ...
   _OUTP( pio_bmide_base_addr + BM_COMMAND_REG, x );
}
...

{
   ...
   _OUTP( pio_bmide_base_addr + BM_STATUS_REG, x );
}
